...
<div class="container">
    <div class="left-section">
        <ul class="tab-list">
            <li class="tab-item">
                <a id="python-section" data-select="one" class="active">PYTHON</a>
            </li>
        </ul>
        <div class="tab-content" id="tab-content">
            <div id="python" class="tab-pane">
                <textarea id="pythonCode" name="python"></textarea>
            </div>
        </div>
    </div>
    <div class="right-section">
        <span id="opbtn"><button onclick="cleanOutput(),executePython()"><i class="fa-solid fa-play"></i></button> Output</span>
        <div id="result"></div> 
    </div>
</div>
